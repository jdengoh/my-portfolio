                ...
                >
                  ...
                  {project.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group relative px-6 py-3 rounded-lg bg-black dark:bg-white dark:text-black text-white text-sm font-medium hover:bg-gray-800 dark:hover:bg-gray-100 transition-all duration-300 flex items-center gap-2 shadow-lg ml-auto"
                    >
